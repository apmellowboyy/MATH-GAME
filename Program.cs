        ...
        private static void addition(int n1, int n2)
        {
            try
            {
                ...
                while (answer != result)
                {
                    ...
                    if (missed > 9)
                    {
                        Console.WriteLine("aint no way you got it wrong.");
                        break;
                    }
            ...
            {
                Console.WriteLine("A problem has gone down and we can't solve it");
            }
        }
        ...
        private static void rightFeedback()
        {
            ...
            switch (num)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Console.WriteLine("LETSSS GOOO YOU WON!");
                    break;
                case 3:
                    Console.WriteLine("SWEET GEEZ YOU DID IT!");
                    break;
                case 4:
                    Console.WriteLine("Well....well...well done.");
                    break;
                case 5:
                    Console.WriteLine("*CLAPPING*");
                    break;
                case 6:
                    Console.WriteLine("Awesome not even a math teacher could do that!");
                    break;
                case 7:
                    Console.WriteLine("That's nuts you did it?");
                    break;
                default:
                    Console.WriteLine("Holy smokes pal you did it!");
                    break;
            }
        }
